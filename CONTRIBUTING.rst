...
4. When you're done making changes, run all the cbytesparse, doc builder and spell checker with `tox <https://tox.readthedocs.io/en/latest/install.html>`_ one command::
...
.. [1] If you don't have all the necessary python versions available locally you can rely on Travis - it will
       `run the tests <https://travis-ci.org/TexZK/bytesparse/pull_requests>`_ for each change you add in the pull request.
